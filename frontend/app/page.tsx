            ...
            <CardContent className="space-y-6">
              ...
              <div className="mt-6 p-4 bg-white/10 rounded-lg text-white text-sm">
                ...
                <ul className="space-y-1">
                  <li><strong>Admin:</strong> admin@edunova.com / password</li>
                  <li><strong>Teacher:</strong> teacher@edunova.com / password</li>
                  <li><strong>Student:</strong> student@edunova.com / password</li>
                </ul>
              </div>
